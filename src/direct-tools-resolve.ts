// ABOUTME: Light pure helpers that resolve direct-tool specs from config + metadata cache.
// ABOUTME: Intentionally free of MCP SDK, OAuth, UI, and executor imports for cold-start.
