...
describe("mcp-auth-flow", () => {
  ...
  describe("authenticate / completeAuth", () => {
    it("should throw if no server URL provided", async () => {
      await assert.rejects(async () => await authenticate("no-url-test", ""), /Invalid URL/);
    });

    it("should reject malformed OAuth redirectUri values", async () => {
      await assert.rejects(
        async () =>
          await startAuth("bad-redirect", "https://api.example.com/mcp", {
            url: "https://api.example.com/mcp",
            auth: "oauth",
    ...
    it("should reject OAuth redirectUri values without an explicit port", async () => {
      await assert.rejects(
        async () =>
          await startAuth("no-port-redirect", "https://api.example.com/mcp", {
            url: "https://api.example.com/mcp",
            auth: "oauth",
    ...
    it("should reject blank OAuth redirectUri values", async () => {
      await assert.rejects(
        async () =>
          await startAuth("blank-redirect", "https://api.example.com/mcp", {
            url: "https://api.example.com/mcp",
            auth: "oauth",
            oauth: { redirectUri: "  " },
          }),
    ...
    it("should reject non-string OAuth redirectUri values", async () => {
      await assert.rejects(
        async () =>
          await startAuth("typed-redirect", "https://api.example.com/mcp", {
            url: "https://api.example.com/mcp",
            auth: "oauth",
    ...
    it("should reject OAuth redirectUri values with fragments", async () => {
      await assert.rejects(
        async () =>
          await startAuth("fragment-redirect", "https://api.example.com/mcp", {
            url: "https://api.example.com/mcp",
            auth: "oauth",
    ...
    it("should reject OAuth redirectUri values with username or password", async () => {
      await assert.rejects(
        async () =>
          await startAuth("credential-redirect", "https://api.example.com/mcp", {
            url: "https://api.example.com/mcp",
            auth: "oauth",
